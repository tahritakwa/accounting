...
@Entity
@NoArgsConstructor
@Table(name = "TJ_ACCOUNT_CUSTOMER", uniqueConstraints = {
        @UniqueConstraint(columnNames = { "GAR_DELETED_TOKEN", "GAR_RELATION_ENTITY_ID" }) })
public class AccountCustomer extends GenericAccountRelation implements Serializable {

    private static final long serialVersionUID = 1L;

    public AccountCustomer(Long id, Account account, Long relationEntityId) {
