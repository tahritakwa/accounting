...
@Entity
@NoArgsConstructor
@Table(name = "TJ_ACCOUNT_BANK", uniqueConstraints = {
        @UniqueConstraint(columnNames = { "GAR_DELETED_TOKEN", "GAR_RELATION_ENTITY_ID" }) })
public class AccountBank extends GenericAccountRelation implements Serializable {
    private static final long serialVersionUID = 1L;

    public AccountBank(Long id, Account account, Long relationEntityId) {
